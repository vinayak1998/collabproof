...
FILE_PURPOSES: dict[str, tuple[str, str, str]] = {
    ".github/workflows/ci.yml": (
        "Automation",
        "Authored workflow",
        "Runs per-commit documentation review, inventory freshness, the pinned Lean build, Python tests, Z3 proofs, generated-fixture freshness, and Python/JavaScript/Lean parity on pushes and pull requests.",
    ),
    ".githooks/pre-commit": (
        "Automation",
        "Authored hook",
    ...
    "collabproof/verify.py": (
        "Python package",
        "Authored source of truth",
        "Checks a complete typed six-field claim against an assessment and returns a fail-closed certificate with coverage, causal rule IDs, and one of six statuses.",
    ),
    "docs/collabproof.js": (
        "Browser",
    ...
    "experiments/corpus/00_README.md": (
        "LLM experiment",
        "Authored warning",
        "Explains that the bundled corpus is paraphrased and must be replaced with official statutory text before publishing grounded-LLM results.",
    ),
    "experiments/corpus/01_194r_benefits.md": (
        "LLM experiment",
        "Placeholder corpus",
        "Summarizes the encoded section 194R, Circular, no-PAN, gross-up, retention, and release-gate rules supplied to grounded experiment arms.",
    ),
    "experiments/corpus/02_cash_tds_194j_194c.md": (
        "LLM experiment",
        "Placeholder corpus",
        "Summarizes the competing cash-fee TDS sections and their unresolved advertising overlap for grounded experiment arms.",
    ),
    "experiments/corpus/03_gst_barter.md": (
        "LLM experiment",
        "Placeholder corpus",
        "Summarizes the encoded GST supply, consideration, valuation, registration-threshold, turnover, and rate rules for grounded experiment arms.",
    ),
    ...
    "experiments/three_arms.py": (
        "LLM experiment",
        "Authored experiment",
        "Runs bare, grounded, and verifier-feedback LLM arms, or a deterministic self-test, while preserving strict output validation and multi-turn context.",
    ),
