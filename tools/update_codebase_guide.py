...
FILE_PURPOSES: dict[str, tuple[str, str, str]] = {
    ".github/workflows/ci.yml": (
        "Automation",
        "Authored workflow",
        "Runs per-commit documentation review, inventory freshness, tests, Z3 proofs, generated-fixture freshness, and Python/JavaScript parity on pushes and pull requests.",
    ),
    ".githooks/pre-commit": (
        "Automation",
        "Authored hook",
